...
type ComplexityRoot struct {
	Mutation struct {
		CreateOffer  func(childComplexity int, input model.NewOffer) int
	...
	Offer struct {
		...
		TitleImageURL func(childComplexity int) int
...
type MutationResolver interface {
	CreateOffer(ctx context.Context, input model.NewOffer) (*model.Offer, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createOffer":
		...
		return e.complexity.Mutation.CreateOffer(childComplexity, args["input"].(model.NewOffer)), true
	...
	case "Offer.location":
		if e.complexity.Offer.Location == nil {
			break
		}

		return e.complexity.Offer.Location(childComplexity), true
	...
	case "Offer.titleImageUrl":
		if e.complexity.Offer.TitleImageURL == nil {
			break
		}

		return e.complexity.Offer.TitleImageURL(childComplexity), true
...
var sources = []*ast.Source{
	{Name: "graph/schema.graphqls", Input: `type Offer {
  id: ID!
  title: String!
  location: String!
  description: String!
...
func (ec *executionContext) _Mutation_createOffer(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().CreateOffer(rctx, args["input"].(model.NewOffer))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Offer_location(ctx context.Context, field graphql.CollectedField, obj *model.Offer) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Offer_titleImageUrl(ctx context.Context, field graphql.CollectedField, obj *model.Offer) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) unmarshalInputNewOffer(ctx context.Context, obj interface{}) (model.NewOffer, error) {
	var it model.NewOffer
	var asMap = obj.(map[string]interface{})
	...
	for k, v := range asMap {
		...
		case "titleImageUrl":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("titleImageUrl"))
			it.TitleImageURL, err = ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) _Offer(ctx context.Context, sel ast.SelectionSet, obj *model.Offer) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "location":
			out.Values[i] = ec._Offer_location(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "description":
		...
		case "titleImageUrl":
			out.Values[i] = ec._Offer_titleImageUrl(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "user":
